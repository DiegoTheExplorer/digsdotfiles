...
hl.on("hyprland.start", function()
	...
	hl.exec_cmd("discord", { workspace = "6" })
...
-- NOTE: pseudo will keep a window in its original floating aspect ratio
-- while still being tiled
...
-- Clipse keybind
hl.bind(mainMod .. " + V", hl.dsp.exec_cmd("wezterm --config font_size=13 start --class clipse -e 'clipse'"))
...
-- Discord will always open in workspace 6
hl.window_rule({
	name = "disc_stay_ws6",
	match = { class = "discord" },
	workspace = 6,
...
-- All vivaldi instances will open in workspace 2
hl.window_rule({
	name = "vivaldi_opens_in_ws2",
